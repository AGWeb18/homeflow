      ...
      <section className="relative py-20 bg-slate-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">
            ...
            <span className="text-primary">build confident</span>
          </h1>
          <p className="text-lg text-slate-300 max-w-2xl mx-auto mb-10">
            HomeFlow combines professional-grade tools with homeowner-friendly
            guidance to streamline your ADU or extension project.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-600 mb-6">
                Stop guessing. Our engine analyzes local zoning bylaws, lot
                geometry, and constraints to tell you exactly what you can
                build.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6">
                From "Idea" to "Occupancy," we break down the complex
                construction process into manageable, actionable tasks.
              </p>
              <ul className="space-y-3">
                {[
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      title: "Contact Structural Engineer",
                      due: "Due in 3 days",
                      status: "pending",
                    },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-600 mb-6">
                Construction costs can spiral. We help you estimate accurately,
                track every dollar, and stay within your means.
              </p>
              <ul className="space-y-3">
                {[
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
            Build smarter, faster, and cheaper with HomeFlow.
          </p>
          <Link
            to="/login?mode=signup"
